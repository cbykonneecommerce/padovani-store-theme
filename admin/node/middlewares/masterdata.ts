...
export async function masterdata(ctx: Context, next: () => Promise<any>) {
  ...
  if (dataEntity != 'LN' && dataEntity != 'CL' && dataEntity != 'EX' && dataEntity != 'MS' && dataEntity != 'SM')
  {
  ...
  console.log("🚀 ~ masterdata ~ paRangeHeader:", paRangeHeader)
  console.log("🚀 ~ masterdata ~ sort:", sort)
