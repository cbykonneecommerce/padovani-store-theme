...
const LeadsPage = (props) => {
    if (window && window?.location?.href?.indexOf("debugLeads") != -1) {
        console.log("Leads:", JSON.stringify(props), props)
    }
                            ...
                            {props?.items?.map((element, index) => (
                                <li key={index}>
                                    <a href={element?.linkSocial} target='_blank'>
                                        <img src={element?.imgSrcSocial} alt={element?.imgAltSocial} />
                                    </a>
                                </li>
                            ))}
                        </ul>
