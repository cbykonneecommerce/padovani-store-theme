            ...
            <div className={styles.content}>
                {
                    modal != null &&
                        <div className={styles.modal}>
                            <div className={styles.closeModal} onClick={ () => { setModal(null) } }>
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M53.3333 53.3334L10.6666 10.6667M53.3333 10.6667L10.6666 53.3334" stroke="white" stroke-width="5.33333" stroke-linecap="round"/></svg>
                            </div>
                            <div className={styles.modalContent}>
                            {
                                props.whatsappOptions.map(elem => {
                                    return(
                                        <a target="_blank" href={`https://api.whatsapp.com/send?phone=${elem.phone}&text=${modal}`}>{elem.name}</a>
                                    )
                                })
                            }
                            </div>
                ...
                <div className={styles.form}>
                    ...
                    {
                        message && 
                            <div id="message" className={`${styles.message} ${styles[message.type]}`}>
