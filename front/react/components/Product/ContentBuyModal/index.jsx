...
import { NumericStepper, Checkbox } from 'vtex.styleguide'
...
const ContentBuyModal = () => {
    ...
    const isAvaible = prodContext?.selectedItem?.sellers[0]?.commertialOffer?.AvailableQuantity > 0;
    const avaibleQty = prodContext?.selectedItem?.sellers[0]?.commertialOffer?.AvailableQuantity;
    const basePrice = prodContext?.selectedItem?.sellers[0]?.commertialOffer?.Price;
        ...
        <div className={styles.ContentWrapModal}>
            ...
            <div className={styles.ContentModalWarnning}>
                ...
                <p>
                    ...
                    <strong style={{marginLeft: "2.5px"}}> {multiplier} m² </strong> onde o <strong> m² </strong> sai por 
                    <strong style={{marginLeft: "2.5px"}}> <FormattedPrice value={basePrice} /> </strong>
                </p>
            </div>
            ...
            <div className={styles.ContentModalQty}>
                ...
                <div className={styles.ContentModalWrapCheckBox}>
                    ...
                    />
                    <label for="checkbox-diagonal"><b>+10%</b> Adicional para recortes e rodapés</label>
                </div>
            ...
            <div className={styles.ContentModalTotal}>
                ...
                <span className={styles.ContentModalInfoQty}>{`${quantity} caixa(s)`} de 
            ...
            <a
                ...
                onClick={event => { 
                    ...
                    addToCart(prodContext?.selectedItem?.itemId, quantity, prodContext?.selectedItem?.sellers[0]?.sellerId);
                }}
            >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_4_318)">
                        ...
                        <path d="M7.34291 23.4064C8.35702 23.4064 9.17911 22.5843 9.17911 21.5702C9.17911 20.5561 8.35702 19.734 7.34291 19.734C6.32881 19.734 5.50671 20.5561 5.50671 21.5702C5.50671 22.5843 6.32881 23.4064 7.34291 23.4064Z" fill="white" />
                        <path d="M18.542 23.4064C19.5561 23.4064 20.3782 22.5843 20.3782 21.5702C20.3782 20.5561 19.5561 19.734 18.542 19.734C17.5279 19.734 16.7058 20.5561 16.7058 21.5702C16.7058 22.5843 17.5279 23.4064 18.542 23.4064Z" fill="white" />
                    </g>
                    <defs>
                        <clipPath id="clip0_4_318">
                            <rect width="24" height="22.8128" fill="white" transform="translate(0 0.593628)" />
                        </clipPath>
                    </defs>
                </svg>
